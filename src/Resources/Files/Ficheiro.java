...
public class Ficheiro {
    ...
    /**
     *Construtor da classe , inicia as variaveis de instancia
     * @param file instancia de um ficheiro
     * @param charset tipo de caracteres
     */
    ...
    /**
     *Converte um vetor de objetos num vetor de strings 
     * @param objVector vetor de obetos
     * @return string resultantes dos objetos
     */
    ...
    /**
     *Le o ficheiro e adiciona cada linha a um vetor de linhas
    ...
    /**
     *
     * @param line string da linha
     * @param character caracter a qual quer separar a linha nos diversos campos
     * @return vetor de strings sem o caracter a fazer split
     */
    ...
    /**
     *Faz a populacao dos dados do ficheiro para as classes 
     * @param lines linhas do ficheiro que queremos ler
     * @param character caracter com que vamos separar as colunas
     * @param anos vetor de anos dos salarios
     * @return vetor com todas as unidades territoriais criadas
