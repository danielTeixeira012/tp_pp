...
public class ContainerOfObjects implements GestorObjetosContrato {
    ...
    /**
     * Retorna o vetor de objetos da actual instancia
     *
    ...
    /**
     * Adiciona ou substitui a determinada posição um objeto
     *
     * @param position posição no vetor
     * @param newObject objeto a adicionar ou substituir
     * @return true caso adicione com sucesso ou falso caso o contrario
     */
