...
/**
 *
 * instanciação de uma classe de gestorSalarios
 */
public class gestorSalario extends Resources.ContainerOfObjects implements GestorSalariosContrato {

    /**
     *construtor de um gestor de salarios
     */
    public gestorSalario() {
    }

    /**
     *construtor de uma gestão de salario com um tamanho
     * @param size
     */
    ...
    /**
     *construtor de uma gestão de tamanho a pratir de um vetor de salarios
     * @param salarios
     */
    ...
    /**
     * adiciona um salario a um vetor de gestão de salarios
     * @param o
     * @return
    ...
    /**
     * Método responsável por obter a listagem de salários de um ou mais municípios para um ou mais anos e para um ou ambos os géneros
     * @param utcs
     * @param os
     * @param os1
     * @return
    ...
    /**
     *Método responsável por obter a listagem de salários de um ou ou ambos os géneros para um ou mais anos para todos os munícipios de uma região
     * @param os
     * @param os1
     * @param tutc
     * @return
     ...
     * @return
     */
    public static Salario[] concat(Salario[] a, Salario[] b) {
   int aLen = a.length;
   int bLen = b.length;
   Salario[] c= new Salario[aLen+bLen];
